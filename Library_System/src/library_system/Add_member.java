...
public class Add_member extends javax.swing.JFrame {
 ...
 static  ArrayList<Member> members_;
  static ArrayList<Employee> emp;
    public Add_member(ArrayList<Item> items_,ArrayList<Member> members_,ArrayList<Employee> emp) {
        initComponents();
          this.items_ = items_;
    ...
    private void initComponents() {
        ...
        type.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Standard", "VIP" }));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Add_member(items_,members_,emp).setVisible(true);
            }
        });
    }
